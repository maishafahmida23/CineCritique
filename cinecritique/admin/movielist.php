...
<div class="container">
  ...
  <a class="navbar-brand" href="#">Movies On Cine Critique</a>
...
if ($run) {
  ...
  <div class="col-md-2">
    ...
    <div class="card" style="width:200px; height:auto;text-align: center;">
    	<p><?php echo $row['id']; ?></p>
     <?php echo "<img height='200px' width='auto' src='../thumb/".$row['img']."'>"; ?>
      <div class="card-body">
