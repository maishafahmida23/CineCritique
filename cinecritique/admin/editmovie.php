...
<div class="container">
  ...
  <div class="form-group">
    ...
    <input type="text" name="mv_m_desc" value="<?php echo$row['meta_description'] ?>" class="form-control" placeholder="Production house" >
  </div>
    <div class="form-group">
   
    <input type="text" name="mv_m_tag" value="<?php echo$row['mv_tag'] ?>" class="form-control" placeholder="Tags" >
  </div>
  <div class="form-group">
