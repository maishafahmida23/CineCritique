...
include'ft.php';
 ...
 ?>
    ...
    <h2>About Us!</h2>
    <h3 style="text-align: center;">Welcome To <span id="W_Name1">Cine Critique</span></h3>
    <p><span id="W_Name2">Cine Critique</span> is a Professional <span id="W_Type1">entertainment</span> Platform. Here we will provide you only interesting content, which you will like very much. We're dedicated to providing you the best of <span id="W_Type2">entertainment</span>, with a focus on dependability and <span id="W_Spec">It gives review about different movies</span>. We're working to turn our passion for <span id="W_Type3">entertainment</span> into a booming <a href="https://www.blogearns.com/2021/05/free-about-us-page-generator.html" rel="do-follow" style="color: inherit; text-decoration: none;">online website</a>. We hope you enjoy our <span id="W_Type4">entertainment</span> as much as we enjoy offering them to you.</p>
